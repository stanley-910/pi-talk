...
The footer shows the playback indicator and speed, for example `▶ · 1.25×`. Pi Talk does not intentionally log or persist:
...
2. Run `/talk test`; confirm the disclosure appears before audio and the footer shows `▶` and current speed.
